...
class MenuPage(BaseForm):
    ...
    __edits_buttons_list = Button(By.XPATH, "//li[@class='edit']//a", "დამატებული მენიუს ედითის ღილაკი")
    __back = Button(By.XPATH, "//div[@class='back_to']", "უკან გამოსვლა")
    __delete_buttons_list = Button(By.XPATH, "//li[@class='delete']//a", "დარედაქტირებული მენიუს წაშლის ღილაკი")
    __confirm_delete = Button(By.XPATH, "//button[@class='gilaki yes']", "წაშლის დადასტურება")

    def __init__(self):
        super().__init__(By.XPATH, "//h1[@class='title']//span[contains(text(),'მენიუ')]",
                         "მენიუს დასახელება ზედა მარცხენა კუთხეში")
